    ...
    def inferenceByVariableElimination(bayesNet, queryVariables, evidenceDict, eliminationOrder):
        ...
        for var in eliminationOrder:
            ...
            if len(joinedFactor.unconditionedVariables()) > 1:
                incrementallyMarginalizedJoint = eliminate(joinedFactor, var)
                factorsList.append(incrementallyMarginalizedJoint)

        queryConditionedOnEvidence = normalize(joinFactors(factorsList))
